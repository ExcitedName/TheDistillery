...
public class GJar extends Item {

	private Block isFull;

		public GJar(Block Full) {
			
			this.setUnlocalizedName("GJar");
			this.setTextureName("GJar");
			this.setCreativeTab(Tabs.IngTab);
			this.isFull = Full;
			
		}
		
public ItemStack onItemRightClick(ItemStack par1GJar, World p_77659_2_, EntityPlayer p_77659_3_)
{
    ...
    {
        FillBucketEvent event = new FillBucketEvent(p_77659_3_, par1GJar, p_77659_2_, movingobjectposition);
        ...
        if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
        {
            ...
            if (flag)
            {
                if (!p_77659_3_.canPlayerEdit(i, j, k, movingobjectposition.sideHit, par1GJar))
                {
                    return par1GJar;
                }
                ...
                if (material == Material.water && l == 0)
                {
                    ...
                    return this.func_150910_a(par1GJar, p_77659_3_, Ing.H2OJar);
                }

                if (material == Material.lava && l == 0)
                {
                    p_77659_2_.setBlockToAir(i, j, k);
                    return this.func_150910_a(par1GJar, p_77659_3_, Ing.LavJar);
                }
            }
            else
            {
...
private ItemStack func_150910_a(ItemStack par1GJar, EntityPlayer p_150910_2_, Item p_150910_3_)
{
    if (p_150910_2_.capabilities.isCreativeMode)
    {
        return par1GJar;
    }
    else if (--par1GJar.stackSize <= 0)
    {
