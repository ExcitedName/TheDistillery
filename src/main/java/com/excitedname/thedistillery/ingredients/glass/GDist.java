...
public class GDist extends Item {

	private Block isFull;
	
		public GDist(Block Full) {
			
			this.setUnlocalizedName("GDist");
			this.setTextureName("GDist");
			this.setCreativeTab(Tabs.IngTab);
			this.isFull = Full;
		}

public ItemStack onItemRightClick(ItemStack par1GDist, World p_77659_2_, EntityPlayer p_77659_3_)
{
    ...
    {
        FillBucketEvent event = new FillBucketEvent(p_77659_3_, par1GDist, p_77659_2_, movingobjectposition);
        ...
        if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
        {
            ...
            if (flag)
            {
                if (!p_77659_3_.canPlayerEdit(i, j, k, movingobjectposition.sideHit, par1GDist))
                {
                    return par1GDist;
                }
                ...
                if (material == Material.water && l == 0)
                {
                    ...
                    return this.func_150910_a(par1GDist, p_77659_3_, Dis.DistH2O);
                }

                if (material == Material.lava && l == 0)
                {
                    p_77659_2_.setBlockToAir(i, j, k);
                    return this.func_150910_a(par1GDist, p_77659_3_, Dis.DistLav);
                }
            }
            else
            {
...
private ItemStack func_150910_a(ItemStack par1GDist, EntityPlayer p_150910_2_, Item p_150910_3_)
{
    if (p_150910_2_.capabilities.isCreativeMode)
    {
        return par1GDist;
    }
    else if (--par1GDist.stackSize <= 0)
    {
