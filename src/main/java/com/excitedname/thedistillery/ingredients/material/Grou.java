...
public class Grou extends Item {

	public static final String[] Meta = new String[] {"Flo", "WPu"};
	@SideOnly(Side.CLIENT)
    private IIcon[] IIcons;

		public Grou() {
			
			this.setUnlocalizedName("Grou");
...
public String getUnlocalizedName(ItemStack par1Grou)
	{
	    int i = MathHelper.clamp_int(par1Grou.getItemDamage(), 0, 1);
	    return super.getUnlocalizedName() + Meta[i];
	}

@SideOnly(Side.CLIENT)
public void getSubItems(Item par1Grou, CreativeTabs par2Tabs, List par3List)
	{
	    for (int i = 0; i < 2; ++i)
	    {
	    	par3List.add(new ItemStack(par1Grou, 1, i));
	    }
	}
...
public void registerIcons(IIconRegister par1Icons)
	{
	    ...
	    {
	        this.IIcons[i] = par1Icons.registerIcon(Ref.MOD_ID + ":" + "Grou" + Meta[i]);
	    }
	}
