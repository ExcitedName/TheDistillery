...
public class H2OJar extends Item {
    
	private Block isFull;	
	
	public H2OJar(BlockLiquid flowingWater) {
		
		this.setUnlocalizedName("H2OJar");
		this.setTextureName("H2OJar");
...
public ItemStack onItemRightClick(ItemStack par1H2OJar, World p_77659_2_, EntityPlayer p_77659_3_)
{
    ...
    {
        FillBucketEvent event = new FillBucketEvent(p_77659_3_, par1H2OJar, p_77659_2_, movingobjectposition);
        ...
        if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
        {
            ...
            if (flag)
            {
                if (!p_77659_3_.canPlayerEdit(i, j, k, movingobjectposition.sideHit, par1H2OJar))
                {
                    return par1H2OJar;
                }
                ...
                if (material == Material.water && l == 0)
                {
                    ...
                    return this.func_150910_a(par1H2OJar, p_77659_3_, Ing.H2OJar);
                }

                if (material == Material.lava && l == 0)
                {
                    p_77659_2_.setBlockToAir(i, j, k);
                    return this.func_150910_a(par1H2OJar, p_77659_3_, Ing.LavJar);
                }
            }
            else
            {
...
private ItemStack func_150910_a(ItemStack par1H2OJar, EntityPlayer p_150910_2_, Item p_150910_3_)
{
    if (p_150910_2_.capabilities.isCreativeMode)
    {
        return par1H2OJar;
    }
    else if (--par1H2OJar.stackSize <= 0)
    {
