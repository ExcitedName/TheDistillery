...
public class CrafMed extends Item {
...
public String getUnlocalizedName(ItemStack par1CrafMed)
	{
	    int i = MathHelper.clamp_int(par1CrafMed.getItemDamage(), 0, 1);
	    return super.getUnlocalizedName() + Meta[i];
	}

@SideOnly(Side.CLIENT)
public void getSubItems(Item par1CrafMed, CreativeTabs par2Tabs, List par3List)
	{
	    for (int i = 0; i < 2; ++i)
	    {
	    	par3List.add(new ItemStack(par1CrafMed, 1, i));
	    }
	}
...
public void registerIcons(IIconRegister par1Icons)
	{
	    ...
	    {
	        this.IIcons[i] = par1Icons.registerIcon(Ref.MOD_ID + ":" + "CrafMed" + Meta[i]);
	    }
	}
