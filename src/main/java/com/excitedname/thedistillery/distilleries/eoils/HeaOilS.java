...
public ItemStack onEaten(ItemStack par1HeaOilS, World par2World, EntityPlayer par3EntityPlayer){
	super.onEaten(par1HeaOilS,  par2World,  par3EntityPlayer);
	
	if (!par3EntityPlayer.capabilities.isCreativeMode)
    {
        --par1HeaOilS.stackSize;
    }
...
public int getMaxItemUseDuration(ItemStack par1HeaOilS)
{
    return 12;
}

public EnumAction getItemUseAction(ItemStack par1HeaOilS)
{
    return EnumAction.eat;
}

public ItemStack onItemRightClick(ItemStack par1HeaOilS, World par2World, EntityPlayer par3EntityPlayer)
{
	par3EntityPlayer.setItemInUse(par1HeaOilS, this.getMaxItemUseDuration(par1HeaOilS));
    return par1HeaOilS;
	
}


public HeaOilS setFirstPotionEffect(int par1, int par2, int par3, float par4){
