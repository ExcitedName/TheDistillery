...
public ItemStack onEaten(ItemStack par1WatOilL, World par2World, EntityPlayer par3EntityPlayer){
	super.onEaten(par1WatOilL,  par2World,  par3EntityPlayer);
	
	if (!par3EntityPlayer.capabilities.isCreativeMode)
    {
        --par1WatOilL.stackSize;
    }
...
public int getMaxItemUseDuration(ItemStack par1WatOilL)
{
    return 12;
}

public EnumAction getItemUseAction(ItemStack par1WatOilL)
{
    return EnumAction.eat;
}

public ItemStack onItemRightClick(ItemStack par1WatOilL, World par2World, EntityPlayer par3EntityPlayer)
{
	par3EntityPlayer.setItemInUse(par1WatOilL, this.getMaxItemUseDuration(par1WatOilL));
    return par1WatOilL;
	
}
		
public WatOilL setFirstPotionEffect(int par1, int par2, int par3, float par4){
