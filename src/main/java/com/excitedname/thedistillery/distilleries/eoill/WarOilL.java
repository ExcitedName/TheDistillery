...
public class WarOilL extends Item {
	...
	public float SecondPotionEffectProbability;
		...
		public WarOilL() {
			...
			this.setUnlocalizedName("WarOilL");
			this.setTextureName("WarOilL");
			this.setCreativeTab(Tabs.DisTab);
			this.setFirstPotionEffect(Potion.damageBoost.id, 20, 1, 1F);
		}

public ItemStack onEaten(ItemStack par1WarOilL, World par2World, EntityPlayer par3EntityPlayer){
	super.onEaten(par1WarOilL,  par2World,  par3EntityPlayer);
	
	if (!par3EntityPlayer.capabilities.isCreativeMode)
    {
        --par1WarOilL.stackSize;
    }
...
public int getMaxItemUseDuration(ItemStack par1WarOilL)
{
    return 12;
}

public EnumAction getItemUseAction(ItemStack par1WarOilL)
{
    return EnumAction.eat;
}

public ItemStack onItemRightClick(ItemStack par1WarOilL, World par2World, EntityPlayer par3EntityPlayer)
{
	par3EntityPlayer.setItemInUse(par1WarOilL, this.getMaxItemUseDuration(par1WarOilL));
    return par1WarOilL;
	
}


public WarOilL setFirstPotionEffect(int par1, int par2, int par3, float par4){
...
public WarOilL setSecondPotionEffect(int par1, int par2, int par3, float par4){
