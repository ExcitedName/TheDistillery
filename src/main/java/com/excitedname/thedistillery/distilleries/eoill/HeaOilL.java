...
public class HeaOilL extends Item {
	...
	public float FirstPotionEffectProbability;
		...
		public HeaOilL() {
			...
			this.setUnlocalizedName("HeaOilL");
			this.setTextureName("HeaOilL");
			this.setCreativeTab(Tabs.DisTab);
			this.setFirstPotionEffect(Potion.heal.id, 1, 0, 1F);
		}

public ItemStack onEaten(ItemStack par1HeaOilL, World par2World, EntityPlayer par3EntityPlayer){
	super.onEaten(par1HeaOilL,  par2World,  par3EntityPlayer);
	
	if (!par3EntityPlayer.capabilities.isCreativeMode)
    {
        --par1HeaOilL.stackSize;
    }
...
public int getMaxItemUseDuration(ItemStack par1HeaOilL)
{
    return 12;
}

public EnumAction getItemUseAction(ItemStack par1HeaOilL)
{
    return EnumAction.eat;
}

public ItemStack onItemRightClick(ItemStack par1HeaOilL, World par2World, EntityPlayer par3EntityPlayer)
{
	par3EntityPlayer.setItemInUse(par1HeaOilL, this.getMaxItemUseDuration(par1HeaOilL));
    return par1HeaOilL;
	
}


public HeaOilL setFirstPotionEffect(int par1, int par2, int par3, float par4){
