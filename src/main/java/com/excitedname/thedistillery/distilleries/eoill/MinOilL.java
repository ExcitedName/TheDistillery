...
public class MinOilL extends Item {
	...
	public float SecondPotionEffectProbability;
		...
		public MinOilL() {
			...
			this.setUnlocalizedName("MinOilL");
			this.setTextureName("MinOilL");
...
public ItemStack onEaten(ItemStack par1MinOilL, World par2World, EntityPlayer par3EntityPlayer){
	super.onEaten(par1MinOilL,  par2World,  par3EntityPlayer);
	
	if (!par3EntityPlayer.capabilities.isCreativeMode)
    {
        --par1MinOilL.stackSize;
    }
...
public int getMaxItemUseDuration(ItemStack par1MinOilL)
{
    return 12;
}

public EnumAction getItemUseAction(ItemStack par1MinOilL)
{
    return EnumAction.eat;
}

public ItemStack onItemRightClick(ItemStack par1MinOilL, World par2World, EntityPlayer par3EntityPlayer)
{
	par3EntityPlayer.setItemInUse(par1MinOilL, this.getMaxItemUseDuration(par1MinOilL));
    return par1MinOilL;
	
}

public MinOilL setFirstPotionEffect(int par1, int par2, int par3, float par4){
...
public MinOilL setSecondPotionEffect(int par1, int par2, int par3, float par4){
